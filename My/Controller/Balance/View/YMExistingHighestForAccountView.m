...
#import "YMExistingHighestForAccountView.h"
#import "YMUserInfoTool.h"

@interface YMExistingHighestForAccountView ()
...
@implementation YMExistingHighestForAccountView
...
-(void)layoutSubviews
{
    ...
    [self.contentView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(SCREENWIDETH * 0.9);
...
-(void)setUserName:(NSString *)userName
{
    ...
    CGFloat  h       = [self.explainLabel sizeThatFits:CGSizeMake(SCREENWIDETH * 0.9 * 0.9,CGFLOAT_MAX)].height;
    CGFloat interval = SCREENHEIGHT * 0.4 * 0.08;
        [self.explainLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.mas_equalTo(SCREENWIDETH * 0.9 * 0.8);
